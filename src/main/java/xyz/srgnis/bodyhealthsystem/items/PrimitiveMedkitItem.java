...
public class PrimitiveMedkitItem extends Item {
    private static final String TARGET_NBT = "PrimitiveMedkitTargetId";
    private static final int REVIVE_TICKS = 16 * 20; // 16 seconds

    public PrimitiveMedkitItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        if (!world.isClient && user instanceof PlayerEntity pe) {
            ...
            if (target instanceof BodyProvider) {
                ...
                body.endRevive(pe);
                // Eligibility: head not destroyed; primitive cannot revive torso-destroyed targets
    ...
    private ExtendedScreenHandlerFactory createScreenHandlerFactory(ItemStack stack, LivingEntity entity) {
        return new ExtendedScreenHandlerFactory() {
            ...
            public Text getDisplayName() {
                return Text.literal("Primitive Medkit");
            }
        };
    }
}
